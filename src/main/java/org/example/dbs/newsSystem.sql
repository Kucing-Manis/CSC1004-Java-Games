...
#  mysql -h host - u user -p (enter, then put password)
#  mysql -h host - u user -p 'database name' (enter, then put password)
# source 'database location and name  (cd C:\Project\Java\demo1\src\main\java\kernel\dbs and newsSystem.sql)';
